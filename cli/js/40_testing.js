...
const OP_DETAILS = {
  ...
  "op_net_accept_tls_client_hello_start": ["accept a TLS stream until ClientHello", "closing a `Deno.TlsListener`"],
  "op_net_accept_tls_client_hello_end": ["complete ClientHello with the coresponding server name, cartificate and key", "closing a `Deno.TlsListener`"],
